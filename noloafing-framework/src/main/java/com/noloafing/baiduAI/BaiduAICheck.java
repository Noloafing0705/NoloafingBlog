...
public class BaiduAICheck {
    ...
    //设置APPID/AK/SK
    private static final String apiKey = "giZZGptHA7yEGMjpOpXPLToP";
    private static final String secretKey = "FNHrnwxvb05K6kameP6TLVMkGHNL9lPB";
    private static final String appId = "28134930";
    //文本内容审核接口
    ...
    public static String getAuth(String ak, String sk) {
        ...
        try {
             ...
             * 返回结果示例
             */
            //System.out.println("===Token_Result:===" + result);
